...
import logo1 from "../../../../public/assets/img/REPL.svg";
                ...
                <div className="row">
                    <div className="col-xl-7 col-md-7">
                        <div className="top__bar-left">
                            <Link href="tel:9680357978"><i className="fas fa-phone-alt"></i>+91 9680357978</Link>
                            <Link href="mailto:us61901@gmail.com"><i className="fas fa-envelope"></i>us61901@gmail.com</Link>
                        </div>
                    </div>
